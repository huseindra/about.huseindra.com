    ...
    return(
       <Container>
        <MainLayout title='☕️ About Me'>
          ...
          2. Technology Management(Agile Methodologies - Scrum,  ITSM - ITIL4 - <strong>certified</strong>, Project Management - PMBOK6)<br/>
          3. Web Technology<br/>
          ...
          <h2 className="font-bold text-xl">Entrepreneurship Journey</h2>
            I had several Entrepreneurship journey such as:<br/>
            1. <Link href="https://dailysocial.id/post/aplikasi-tukutu"><a target="_blank">Tukutu(2018-2019)</a></Link> - eCommerce - <strong>closed</strong><br/>
            2. <Link href="https://www.instagram.com/kampusfund/"><a target="_blank">Kampusfund(2018)</a></Link> - Crowdfunding - <strong>closed</strong><br/>
            3. <Link href="https://zonaedukasi.huseindra.com"><a>Zona Edukasi(2014-2016)</a></Link> - Media & Event Students - <strong>closed</strong><br/>
            3.<Link href="https://www.facebook.com/huublamedia/"><a> Huubla(2013-2016)</a></Link>  - Media Blogs - <strong>closed</strong><br/><br/>
